...
<head>
	...
	<title>Offerredeem - Submit new offer</title>
...
<ul class="nav nav-tabs tab-disable" role="tablist">
    ...
    <li role="presentation">
        <a href="#media" aria-controls="media" role="tab" data-toggle="">
            ...
            <li role="presentation">
            <a href="#terms" aria-controls="terms" role="tab" data-toggle="">
                5. Terms            </a>
        </li>        
...
<!-- Tab panes -->
<form method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>offer/submit">
        <div class="white-block">
        <div class="white-block-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="basic">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ad_title" id="ad_title" value="" class="form-control require">
...
<div id="wp-ad_description-editor-container" class="wp-editor-container"><div id="qt_ad_description_toolbar" class="quicktags-toolbar"></div><textarea class="wp-editor-area" style="height: 200px" autocomplete="off" cols="40" name="ad_description" id="offerdesc"></textarea></div>
</div>
                    ...
                    <input type="text" name="ad_points" id="ad_points" value="" class="form-control"> 
                    <br/>
                    <label for="ad_tags">Tags / Keywords</label>
                    <p class="description">Input comma separated tags</p>
                    <input type="text" name="ad_tags" id="ad_tags" value="" class="form-control">                            
                	...
                	<div class="row">
                		<div class="col-md-6">
                            ...
                            <input type="text" name="ad_price" id="ad_price" value="" class="form-control">
                		...
                		<div class="col-md-6">
                            ...
                            <input type="text" name="ad_off_price" id="ad_discounted_price" value="" class="form-control">                			
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="checkbox">
                                <input type="checkbox" name="ad_call_for_price" id="ad_call_for_price" value="1" >
                                <label for="ad_call_for_price">Call For Info </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ad_phone" id="ad_phone" value="" class="form-control">
        	...
        	You have to populate all required fields. Required fields are marked with *        </p>
                ...
                <select name="set_location" class="form-control require" id="set_location">
                    ...
                    <div class="gmap">
                        ...
                        <input type="hidden" name="ad_gmap_longitude" value="" class="longitude require">
                        <input type="hidden" name="ad_gmap_latitude" value="" class="latitude require">
                    </div>
