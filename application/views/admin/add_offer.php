...
<head>
	...
	<title>Admin Panel - Add Offer </title>
...
<ul class="nav nav-tabs tab-disable" role="tablist">
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/submitOffer">
        <div class="white-block">
        <div class="white-block-content">
...
<div id="wp-ad_description-editor-container" class="wp-editor-container"><div id="qt_ad_description_toolbar" class="quicktags-toolbar"></div>
<textarea class="wp-editor-area" style="height: 200px" autocomplete="off" cols="40" name="ad_description" id="offerdesc"></textarea></div>
</div>
