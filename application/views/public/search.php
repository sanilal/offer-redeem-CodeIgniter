...
<head>
	...
	<title>Offerredeem - Search Offers</title>
                ...
                <ul class="list-unstyled list-inline">
                    <li>
                        <select class="form-control select2 category" name="category" data-placeholder="Category">
                            ...
                            <?php foreach ($categories->result() as $cat){ ?> 
                                <option value="<?php echo $cat->category_id; ?>" <?php if($cat->category_id==$cat_id){ echo 'selected="selected"';} ?>><?php echo $cat->cat_name; ?></option>  
                                <?php } ?>                       
                        </select>
                        <i class="fa fa-bars"></i>                    
                    </li>
                    <li>
                        <input type="text" class="form-control keyword" name="keyword" value="<?php echo $key; ?>" placeholder="Keyword">
                    ...
                    <li>
                        <select name="location" class="form-control select2 require" data-placeholder="Location">
                            ...
                            <option value="<?php echo $loc->location_id; ?>" <?php if($loc->location_id==$loc_id){ echo 'selected="selected"';} ?>><?php echo $loc->location_name; ?></option>
                            <?php } ?>
                        </select>                       
                    ...
                    <li>
                        <a href="javascript:;" class="btn submit-form">
                            Search                        </a>
                                            ...
                                            <?php /*?><li class="advanced-filter-wrap">
                ...
                <div class="white-block search-block">
                    <div class="white-block-content">
                        <div class="row">
                            <div class="col-md-6">
                                <p>
                                Showing <?php /*?>1 - 9 of 9 total  ads found<?php */?> Offers
                                                               </p>
                            </div>
                            <div class="col-md-3">
                           ...
                           <?php /*?>     <a href="javascript:;" class="reset-search">
                                    <i class="fa fa-times-circle"></i> RESET                                </a>    <?php */?>                    
                            </div>
                        </div>
                    </div>
                </div>
